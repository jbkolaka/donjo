...
// Limiter is a process-local, fixed-window rate limiter keyed by client
// (remote IP). Acceptable for the current single-instance-per-service
...
// Middleware rejects over-limit clients with HTTP 429 before they hit any
// handler.
